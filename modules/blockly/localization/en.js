module.exports = function init(Blockly){//A name has been set, in order to make it runnable when sent to front-end
  ...
  Blockly.Msg["BLOCK_SLASH_COMMAND_ARG_STRING_TOOLTIP"] = "Add a string argument to the slash command, with a name and description";
  ...
  Blockly.Msg["BLOCK_SLASH_COMMAND_GET_STRING"] = "Get the string argument nammed %1";
