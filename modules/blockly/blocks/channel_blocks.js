...
module.exports = {
  blocks: JSON.stringify([
      ...
      args0: [
        {
          type: "input_value",
          name: "channel",
          check: ["Channel", "VoiceChannel", "ThreadChannel"],
        },
      ],
      previousStatement: "block",
      nextStatement: "block",
    ...
    },
    {
      ...
      output: ["Channel", "VoiceChannel", "ThreadChannel"],
      colour: 75,
      ...
      args0: [
        {
          type: "input_value",
          name: "userOrRank",
          check: ["User", "Rank", "EveryoneRank"],
        },
        {
          type: "field_dropdown",
          name: "permission",
          options: [
            ["%{BKY_PERMISSION_SEE_CHANNEL}", "SEE_CHANNEL"],
            ["%{BKY_PERMISSION_MANAGE_CHANNEL}", "MANAGE_CHANNEL"],
            ["%{BKY_PERMISSION_MANAGE_CHANNEL_PERMISSIONS}", "MANAGE_CHANNEL_PERMISSIONS"],
            ["%{BKY_PERMISSION_MANAGE_WEBHOOKS}", "MANAGE_CHANNEL_WEBHOOKS"],
            ["%{BKY_PERMISSION_CREATE_INVITE}", "CREATE_INVITE"],
            ["%{BKY_PERMISSION_SEND_MESSAGES}", "SEND_MESSAGES"],
            ["%{BKY_PERMISSION_SEND_MESSAGE_IN_THREADS}", "SEND_MESSAGES_IN_THREADS"],
            ["%{BKY_PERMISSION_CREATE_PUBLIC_THREADS}", "CREATE_PUBLIC_THREADS"],
            ["%{BKY_PERMISSION_CREATE_PRIVATE_THREADS}", "CREATE_PRIVATE_THREADS"],
            ["%{BKY_PERMISSION_EMBED_LINKS}", "EMBED_LINKS"],
            ["%{BKY_PERMISSION_ADD_FILES}", "ADD_FILES"],
            ["%{BKY_PERMISSION_ADD_REACTIONS}", "ADD_REACTIONS"],
            ["%{BKY_PERMISSION_USE_EXTERNAL_EMOJIS}", "USE_EXTERNAL_EMOJIS"],
            ["%{BKY_PERMISSION_USE_EXTERNAL_STICKERS}", "USE_EXTERNAL_STICKERS"],
            ["%{BKY_PERMISSION_PING_EVERYONE}", "PING_EVERYONE"],
            ["%{BKY_PERMISSION_MANAGE_MESSAGES}", "MANAGE_MESSAGES"],
            ["%{BKY_PERMISSION_MANAGE_THREADS}", "MANAGE_THREADS"],
            ["%{BKY_PERMISSION_SEE_OLD_MESSAGES}", "SEE_OLD_MESSAGES"],
            ["%{BKY_PERMISSION_SEND_VOICE_MESSAGE}", "SEND_VOICE_MESSAGE"],
            ["%{BKY_PERMISSION_USE_APP_COMMANDS}", "USE_APP_COMMANDS"],
            ["%{BKY_PERMISSION_CONNECT_TO_VOICE_CHANNEL}", "CONNECT_TO_VOICE_CHANNEL"],
            ["%{BKY_PERMISSION_SPEAK}", "SPEAK"],
            ["%{BKY_PERMISSION_USE_VIDEO}", "USE_VIDEO"],
            ["%{BKY_PERMISSION_START_ACTIVITY}", "START_ACTIVITY"],
            ["%{BKY_PERMISSION_USE_VOICE_DETECTION}", "USE_VOICE_DETECTOR"],
            ["%{BKY_PERMISSION_PRIORITY_SPEAKER}", "PRIORITY_SPEAKER"],
            ["%{BKY_PERMISSION_MUTE_MEMBER}", "MUTE_MEMBER"],
            ["%{BKY_PERMISSION_DEAF_MEMBER}", "DEAF_MEMBER"],
            ["%{BKY_PERMISSION_MOOVE_MEMBER}", "MOOVE_MEMBER"],
            ["%{BKY_PERMISSION_MANAGE_VOICE_CHANNEL_EVENTS}", "MANAGE_VOICE_CHANNEL_EVENTS"],
          ],
        },
        {
          type: "input_dummy",
    ...
    },
    {
      ...
      args0: [
        ...
        },
        {
          ...
          name: "isGranted",
          options: [
            ["%{BKY_PERMISSION_GRANT_PERMISSION}", "GRANT"],
            ["%{BKY_PERMISSION_DENY_PERMISSION}", "DENY"],
            ["%{BKY_PERMISSION_UNDEFINED_PERMISSION}", "UNDEFINED"],
          ],
        },
        {
          type: "input_dummy",
