...
module.exports = (Blockly) => {
  ...
  Blockly.Extensions.register("block_storage_input_dataname_extension", function () {
    // this refers to the block that the extension is being run on
    const thisBlock = this;
    const field = thisBlock.getField("DATANAME");
    field.setValidator((value) => {
      ...
      if (typeof definedRegexes !== "undefined") {
        //Server side
        valid = definedRegexes.dataStorageName(value);
      } else {
        //Client side
        valid = dataStorageNameRegex(value);
      }
