...
module.exports = {
  ...
  addWorkspace: async function(databasePool, guildId, xml, premium){
    try{
      let result = await databasePool.query('INSERT INTO server_workspace (server_id, xml) VALUES ($1, $2);', [guildId, xml]);
      ...
      let result2 = await databasePool.query('DELETE FROM server_workspace WHERE workspace_id IN (SELECT workspace_id FROM server_workspace WHERE server_id = $1 ORDER BY workspace_id DESC OFFSET $2);', [guildId, maxRollbacks]);
