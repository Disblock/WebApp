...
module.exports = {
  ...
  panelIndexMessageDiv1:
    'Welcome on Disblock\'s panel !<br><br>You can add the bot to your server by clicking on  "Invite", in the menu on the left.<br><br>Also, to manage a server, you need the "Administrator" permission on it !<br><br>Finally, if you need help or have questions, feel free to join the <a href="https://discord.gg/4b6j3UBKWp">support server</a>.',
  panelIndexMessageDiv2:
    'Disblock is also open-source and licensed under the MIT License ! You can check our project on Github <a href="https://github.com/Disblock/WebApp">here</a>.',
  ...
  showWindowSendCodeSuccessText:
    "Your workspace was saved, and is ready to use ! If you created a slash command, don't forget to use /reloadcommands in your server !",
  ...
  showWindowGivePremiumToServerSuccessText:
    "The created code on the old server will be disabled, and you can now use the advantages of Premium on the new server !",
  showWindowPremiumCodeSuccessTitle: "Valid code !",
  showWindowPremiumCodeSuccessText:
    "You Successfully redeemed this code, and a new Premium slot was added to your account. Thanks for your support ! ;)",
  showWindowPremiumCodeFailedTitle: "Invalid code",
  showWindowPremiumCodeFailedText:
    "Check that the code is correctly written, and retry. This code is maybe already used.",
  ...
  workspaceToJsUncompleteBlock:
    "There is an uncomplete block in your code ! Please add the missing value to this block before trying again...",
  errorWithStorageBlocks:
    "There is an error with your data storage blocks ! Please, check that everything is correct before trying again...",

  /* Rollback panel */
  rollbackPageTitle: "Rollback to a previous state your server's workspace",
  rollbackPageText:
    "Here, you can rollback to an old state of your server's workspace. When you rollback to an old version, we will immediatly update the code executed by the bot to the restored version. If you rollback your workspace, the actual state will be restorable here.",
  ...
  premiumPageText:
    "If you have some Premium slots, you can manage them here. You can also redeem a code, or support us to get some Premium slots.<br>The Premium feature isn't a product, but just a bonus for supporting the bot.",
