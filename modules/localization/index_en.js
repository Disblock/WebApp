...
module.exports = {
  ...
  whyDisblock1Text:
    "With Disblock, you can easily create your own commands, and automatically execute some actions when something is happening !",
  whyDisblock1Link: "Check the features list !",

  whyDisblock2Title: "Customize everything",
  whyDisblock2Text:
    "You can create events, commands and everything that you will need with a totally no-code, block based editor !",
  whyDisblock2Link: "See some examples of what can be done with Disblock",
